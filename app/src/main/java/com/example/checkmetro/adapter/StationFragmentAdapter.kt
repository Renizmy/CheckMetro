...
import com.example.checkmetro.ui.fragments.StationFragmentDirections
import kotlinx.android.synthetic.main.station_view.view.*

class StationFragmentAdapter(val stations: List<StationsLine>) : RecyclerView.Adapter<StationFragmentAdapter.StationViewHolder>() {
    ...
    override fun onBindViewHolder(holder: StationViewHolder, position: Int) {
        ...
        holder.stationview.setOnClickListener{
            val action=StationFragmentDirections.actionStationFragmentToStationDetailsFragment(station.slug,station.line)
